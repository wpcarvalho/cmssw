...
#process.CondDB.connect = 'sqlite_file:../../CondTools/Geometry/PPSGeometry_2018_fromDD.db'
#process.CondDB.connect = 'sqlite_file:../../CondTools/Geometry/test/writehelpers/PPSRECO_Geometry_2017.db'
process.CondDB.connect = 'sqlite_file:../../CondTools/Geometry/test/writehelpers/PPSRECO_Geometry_test_2018.db'
...
process.PoolDBESSource = cms.ESSource("PoolDBESSource",
    ...
    toGet = cms.VPSet(
      cms.PSet(
        ...
        tag = cms.string("PPSRECO_Geometry_2018_113YV1")
      )
    )
)
