...
from Geometry.VeryForwardGeometry.geometryRPFromDD_2021_cfi import XMLIdealGeometryESSource_CTPPS
...
process.BigXMLWriter = cms.EDAnalyzer("OutputDDToDDL",
                                      ...
                                      fileName = cms.untracked.string("./ge2021SingleBigFile.xml")
                                      )
